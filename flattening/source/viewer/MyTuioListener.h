...
#ifndef MYTUIOLISTENER_H
#define MYTUIOLISTENER_H
	...
	public:
		 ...
		 */
		 void refresh(TuioTime ftime);
          ...
          private: 
                  float previousX;  // stores the last value of x
                  float previousY;  // stores the last value of y   
                 // float previousZ;  // stores the last value of z   maybe it will be erased
                  float pre_rotX;   // stores the last value of x for the rotation part
                  float pre_rotY;   // stores the last value of y for the rotation part
